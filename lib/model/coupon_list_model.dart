...
class CouponListResponse {
  ...
  factory CouponListResponse.fromJson(Map<String, dynamic> json) {
    return CouponListResponse(
      expireCupon: json['expire_cupon'] is List
          ? List<CouponData>.from(
              json['expire_cupon'].map((x) => CouponData.fromJson(x)))
          : [],
      validCupon: json['valid_cupon'] is List
          ? List<CouponData>.from(
              json['valid_cupon'].map((x) => CouponData.fromJson(x)))
          : [],
    );
  }
