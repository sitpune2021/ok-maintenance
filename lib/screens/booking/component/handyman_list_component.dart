...
class HandymanListComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: appBarWidget(language.handymanList,
          color: context.primaryColor, textColor: white),
                      ...
                      children: [
                        Container(
                          ...
                          child: CachedImageWidget(
                            url: handymanData.profileImage.validate().isNotEmpty
                                ? handymanData.profileImage.validate()
                                : '',
                            width: context.width(),
                            height: 110,
                            fit: BoxFit.cover,
                        ...
                        Marquee(
                                child: Text(handymanData.displayName.validate(),
