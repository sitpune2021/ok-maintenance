...
class HelpDeskDetailResponse {
  ...
  factory HelpDeskDetailResponse.fromJson(Map<String, dynamic> json) {
    return HelpDeskDetailResponse(
      data: json['activity'] != null
          ? (json['activity'] as List)
              .map((i) => HelpDeskActivityData.fromJson(i))
              .toList()
          : null,
...
class HelpDeskActivityData {
    ...
    return HelpDeskActivityData(
      ...
      attachmentsArray: json['attachments_array'] != null
          ? (json['attachments_array'] as List)
              ...
              .toList()
          : null,
      helDeskAttachments: json['helpdesk_attachments'] != null
          ? new List<String>.from(json['helpdesk_attachments'])
          : null,
      helpDeskAttachmentsArray: json['helpdesk_attachments_array'] != null
          ? (json['helpdesk_attachments_array'] as List)
              .map((i) => Attachments.fromJson(i))
              .toList()
          : null,
    );
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.helpDeskAttachmentsArray != null) {
      data['helpdesk_attachments_array'] =
          this.helpDeskAttachmentsArray!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
