...
const APP_NAME = 'Ok Maintenance';
const APP_NAME_TAG_LINE = 'On-Demand Home Services App';
var defaultPrimaryColor = Color(0xFF5F60B9);

// Don't add slash at the end of the url

const DOMAIN_URL = 'https://okewebs.com'; // Don't add slash at the end of the url
...
const PROVIDER_PACKAGE_NAME = 'com.okmaintenance.provider';
...
const PRIVACY_POLICY_URL = 'https://okewebs.com/privacy-policy';
const HELP_AND_SUPPORT_URL = 'https://okewebs.com/privacy-policy';
const REFUND_POLICY_URL = 'https://okewebs.com/refund-policy';
const INQUIRY_SUPPORT_EMAIL = 'support@okewebs.com';

/// You can add help line number here for contact. It's demo number
const HELP_LINE_NUMBER = '+919552655234';
